package com.c23_pr505.batikco.customview
...
import com.c23_pr505.batikco.R
...
class CustomRegisterEditText @JvmOverloads constructor(
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.custom_register, this, true)
        edtEmail = findViewById(R.id.etUsername)
        edtPassword = findViewById(R.id.etEmail)
        edtUsername = findViewById(R.id.etPassword)
